...
pub struct RaftMessage {
    /// postcard-serialized OpenRaft struct (AppendEntriesRequest, etc.)
...
pub mod raft_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::RaftMessage>, tonic::Status> {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/raft.RaftService/AppendEntries" => {
                    ...
                    impl<T: RaftService> tonic::server::UnaryService<super::RaftMessage> for AppendEntriesSvc<T> {
                ...
                "/raft.RaftService/RequestVote" => {
                    ...
                    impl<T: RaftService> tonic::server::UnaryService<super::RaftMessage> for RequestVoteSvc<T> {
                        type Response = super::RaftMessage;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                ...
                "/raft.RaftService/InstallSnapshot" => {
                    ...
                    impl<T: RaftService> tonic::server::UnaryService<super::RaftMessage> for InstallSnapshotSvc<T> {
                        type Response = super::RaftMessage;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
